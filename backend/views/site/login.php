        ...
        <?php $form = ActiveForm::begin(['id' => 'login-form']); ?>
            <div class="panel panel-body login-form">
                <div class="text-center">
                    ...
                    <h5 class="content-group">Ingresa a tu cuenta</h5>
                </div>
                ...
                <div class="form-group">
                    <?= Html::submitButton('Entrar <i class="icon-circle-right2 position-right"></i>', ['class' => 'btn bg-primary btn-block', 'name' => 'login-button']) ?>
                </div>
